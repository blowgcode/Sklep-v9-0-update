...
?>  
			...
			<?php echo $this->data['main_css_class']; ?> .chbs-tab-custom.ui-tabs .ui-tabs-nav>li.ui-tabs-active>a,
			...
			html <?php echo $this->data['main_css_class']; ?> .chbs-tab-custom.ui-tabs .ui-tabs-panel
			{
				border-top-color:#<?php echo $this->data['color'][1]; ?>;
			}
			
			<?php echo $this->data['main_css_class']; ?>.chbs-datepicker.ui-datepicker td a.ui-state-hover,
			...
			<?php echo $this->data['main_css_class']; ?> .chbs-tab-custom.ui-tabs .ui-tabs-nav>li.ui-tabs-active>a,
			body.rtl <?php echo $this->data['main_css_class']; ?> .chbs-tab-custom.ui-tabs .ui-tabs-nav>li.ui-tabs-active>a
			{
			...
			<?php echo $this->data['main_css_class']; ?> .chbs-tab-custom.ui-tabs .ui-tabs-nav>li.ui-tabs-active+li>a
			{
			...
			body.rtl <?php echo $this->data['main_css_class']; ?> .chbs-tab-custom.ui-tabs .ui-tabs-nav>li.ui-tabs-active+li>a
			{
				border-right-color:#<?php echo $this->data['color'][1]; ?>;
			}
			
			<?php echo $this->data['main_css_class']; ?>.chbs-datepicker.ui-datepicker td a.ui-state-hover,
			<?php echo $this->data['main_css_class']; ?>.chbs-datepicker#ui-datepicker-div td a.ui-state-hover,
			...
			<?php echo $this->data['main_css_class']; ?> .chbs-vehicle .chbs-vehicle-content>.chbs-vehicle-content-price>span>span,
...
?>			
			...
			<?php echo $this->data['main_css_class']; ?>.chbs-datepicker.ui-datepicker,
			<?php echo $this->data['main_css_class']; ?>.chbs-datepicker#ui-datepicker-div,
			...
			<?php echo $this->data['main_css_class']; ?> .chbs-tab-custom.ui-tabs .ui-tabs-nav>li>a,
			...
			<?php echo $this->data['main_css_class']; ?>.chbs-datepicker.ui-datepicker td
			{
				background-color:#<?php echo $this->data['color'][3]; ?> !important;
			}
...
<?php
		...
		{
?>  
			<?php echo $this->data['main_css_class']; ?>.chbs-datepicker.ui-datepicker th,
			<?php echo $this->data['main_css_class']; ?>.chbs-datepicker.ui-datepicker .ui-datepicker-prev,
			<?php echo $this->data['main_css_class']; ?>.chbs-datepicker.ui-datepicker .ui-datepicker-next,
			...
			<?php echo $this->data['main_css_class']; ?> .chbs-vehicle .chbs-vehicle-content>.chbs-vehicle-content-price>span>span.chbs-vehicle-content-price-before-discount
			{
...
?>  
			...
			<?php echo $this->data['main_css_class']; ?> .chbs-tab-custom.ui-tabs .ui-tabs-panel,
			<?php echo $this->data['main_css_class']; ?> .chbs-tab-custom.ui-tabs .ui-tabs-nav>li>a,
			body.rtl <?php echo $this->data['main_css_class']; ?> .chbs-tab-custom.ui-tabs .ui-tabs-nav>li>a,
			<?php echo $this->data['main_css_class']; ?> .chbs-tab-custom.chbs-tab-custom-responsive.ui-tabs .ui-tabs-nav>li.ui-tabs-active+li>a,
			...
			<?php echo $this->data['main_css_class']; ?>.chbs-width-300 .chbs-tab-custom.ui-tabs .ui-tabs-nav>li.ui-tabs-active+li>a,
			body.rtl <?php echo $this->data['main_css_class']; ?>.chbs-width-300 .chbs-tab-custom.ui-tabs .ui-tabs-nav>li.ui-tabs-active+li>a,
			...
			<?php echo $this->data['main_css_class']; ?>.chbs-widget.chbs-widget-style-4 .chbs-main-content-step-1 .chbs-tab.ui-tabs .ui-tabs-panel,
			<?php echo $this->data['main_css_class']; ?>.chbs-widget.chbs-widget-style-2 .chbs-tab.ui-tabs .ui-tabs-panel>div:last-child
			{
			...
			<?php echo $this->data['main_css_class']; ?>.chbs-datepicker.ui-datepicker .ui-datepicker-prev.ui-state-hover,
			<?php echo $this->data['main_css_class']; ?>.chbs-datepicker.ui-datepicker .ui-datepicker-next.ui-state-hover,	   
...
<?php
		...
		{
?>  
			<?php echo $this->data['main_css_class']; ?>.chbs-datepicker.ui-datepicker td a,
			<?php echo $this->data['main_css_class']; ?>.chbs-datepicker.ui-datepicker .ui-datepicker-title,
			<?php echo $this->data['main_css_class']; ?>.chbs-datepicker.ui-datepicker .ui-datepicker-prev.ui-state-hover,
			<?php echo $this->data['main_css_class']; ?>.chbs-datepicker.ui-datepicker .ui-datepicker-next.ui-state-hover, 
			<?php echo $this->data['main_css_class']; ?>.chbs-datepicker#ui-datepicker-div .ui-datepicker-prev.ui-state-hover, 
			<?php echo $this->data['main_css_class']; ?>.chbs-datepicker#ui-datepicker-div .ui-datepicker-next.ui-state-hover,  
...
<?php
		...
		{
?>  
			<?php echo $this->data['main_css_class']; ?>.chbs-datepicker.ui-datepicker td.ui-datepicker-unselectable,
...
<?php
		...
		{
?>  
			<?php echo $this->data['main_css_class']; ?> [class^="chbs-meta-icon-2-"]::before,
			<?php echo $this->data['main_css_class']; ?> [class*=" chbs-meta-icon-2-"]::before
			{
			...
			<?php echo $this->data['main_css_class']; ?> .chbs-notice-fixed
			{
...
?>	
			...
			<?php echo $this->data['main_css_class']; ?> .chbs-notice,
			<?php echo $this->data['main_css_class']; ?> .chbs-notice-fixed,
			<?php echo $this->data['main_css_class']; ?> .chbs-notice-fixed a,
			<?php echo $this->data['main_css_class']; ?> .chbs-notice-fixed a:hover,
			<?php echo $this->data['main_css_class']; ?> .chbs-location-add:hover,
			<?php echo $this->data['main_css_class']; ?> .chbs-location-remove:hover,
			<?php echo $this->data['main_css_class']; ?> .chbs-form-field .chbs-quantity-section .chbs-quantity-section-button:hover,
			<?php echo $this->data['main_css_class']; ?> .chbs-button.chbs-button-style-1,
